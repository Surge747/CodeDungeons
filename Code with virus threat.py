...
#monsters Data
DL1=["D1","D2","D3","D4",["Guardian",[20,4]],["Ghoul",[15,8]],["Wilter",[15,8]]]
DL2=["C1","C2","C3",["Alien",[20,7]],["Banshee",[23,8]],["Warden",[26,13]]]

#Initialize Questions.txt file
f=open("Assets/Questions/Questions.txt","r+")
Q=f.readlines()
...
def boss():
    ...
    l=os.uname()[1].split("-")
    st("{} {}".format(l[0],l[1]),n=120)
    st("You have limited time before a virus file in the game code takes over your computer","ERROR")
    st("Good luck",n=80)
    battle(["Python",[50,13]])
...
def virus():
    try:
        ...
        for a in range(10):
            try:
                os.mkdir("Virus/InFecTed vIrUs fIle {}".format(random.randint(0,10000)))
            except OSError:
                pass
    except OSError:
        for a in range(10):
